...
def affine_table(key_a_text, key_b_text, column_values, tbl_obj):
    ...
    tables.table(column_values, tables.table_column, tbl_obj, h_headers=h_headers)
...
def caesar_key_table(column_values, table_obj):
    h_headers = ('№', '->', '№', '->', '№', '->')
    tables.table(column_values, tables.table_column, table_obj, h_headers=h_headers)
...
def vigenere_table(row_values, table_obj, alphabet):
    ...
    tables.table(row_values, tables.table_row, table_obj, h_headers, v_headers)
