from components import chars, dialogs, enc_tables
from helpers import tables
from scripts.encryption import cs
...
def enc_proc_key_cs(form_data):
    proc_key_cs(form_data, cs.enc_affine_cs)


def dec_proc_key_cs(form_data):
    proc_key_cs(form_data, cs.dec_affine_cs)
