...
def init_simple_permutation(parent, ui):
    ...
    ui.enc_smp_auto_btn.clicked.connect(lambda: prm_handlers.auto_simple_prm(parent, enc_form))
...
def init_key_permutation(parent, ui):
    ...
    ui.enc_kpm_auto_btn.clicked.connect(lambda: prm_handlers.auto_key_prm(parent, enc_form))
...
def init_double_permutation(parent, ui):
    ...
    ui.enc_dpm_auto_btn.clicked.connect(lambda: prm_handlers.auto_double_prm(parent, enc_form))
