from src.handlers import cs_handlers
...
def init_classic_caesar(parent, ui):
    ...
    ui.enc_cs_auto_btn.clicked.connect(lambda: cs_handlers.auto_classic_cs(parent, enc_form))
...
def init_affine_caesar(parent, ui):
    ...
    ui.enc_acs_auto_btn.clicked.connect(lambda: cs_handlers.auto_affine_cs(parent, enc_form))
...
def init_key_caesar(parent, ui):
    ...
    ui.enc_kcs_auto_btn.clicked.connect(lambda: cs_handlers.auto_key_cs(parent, enc_form))
